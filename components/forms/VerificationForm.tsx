    ...
    return(
        <form className="my-4 space-y-1">
            <div>
                ...
                <input className="outline-none border border-zinc-600 py-1 px-2" placeholder="Full name" autoComplete="name" type="text" id="name" name="name" minLength={4} maxLength={40} required />
            </div>
            <div>
